...
ParticleEmitter::ParticleEmitter(): m_particles(nullptr), m_firstDead(0), m_maxParticles(0), m_position(1,1,1), m_vao(0), m_vbo(0), m_ibo(0),m_vertexData(nullptr)
{
}
...
void ParticleEmitter::update(float a_deltaTime, const mat4& a_cameraTransform, vec3 position)
{
	// spawn particles 
